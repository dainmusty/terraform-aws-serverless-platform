...
resource "aws_cloudfront_distribution" "primary" {
  ...
  viewer_certificate {
    ...
    acm_certificate_arn      = var.acm_certificate_validation_primary_certificate_arn
...
#   viewer_certificate {
#     acm_certificate_arn      = var.acm_certificate_validation_secondary_certificate_arn
#     ssl_support_method       = "sni-only"
#     minimum_protocol_version = "TLSv1.2_2021"
#   }
# }
