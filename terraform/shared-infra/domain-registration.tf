...
module "domain_registration" {
  ...
  contact = {
    ...
    email         = "admin@company-domain-name.com"
    phone_number  = "+11234567890"
    address       = "123 Main Street"
    city          = "companycitylocation"
    state         = "companystate"
    country_code  = "US"          #expected country_code to be one of ["AC" "AD" "GH" "AF" "AG" "AL"] GH is supposed to be the country code for Ghana
    zip_code      = "28027"
  }
}
